...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 sidebar-minimal flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary text-sm font-semibold text-white">AV</div>
          <span className="text-lg font-semibold text-white">AudioVisor</span>
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M12 4V1L8 5l4 4V6c2.76 0 5 2.24 5 5 0 1.02-.31 1.97-.84 2.76l1.46 1.46C18.5 14.12 19 12.61 19 11c0-3.87-3.13-7-7-7zm-5.62.24L4.92 2.78C3.5 4.26 2.6 6.05 2.6 8c0 3.87 3.13 7 7 7v3l4-4-4-4v3c-2.76 0-5-2.24-5-5 0-1.02.31-1.97.84-2.76z"
                      fill=""
                    />
                  </svg>
                  Presets
              ...
              {/* <!-- Menu Item Customize Dashboard --> */}
              <li>
                <NavLink
                  to="/customize"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('customize') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
