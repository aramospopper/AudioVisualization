...
import AudioVisorLogo from '../../../assets/images/logo/AudioVisor Glasses Logo.png';
...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!result.success) {
      setError(result.error || 'Invalid email or password combination. Please try again.');
    }
  };
        ...
        <div className="flex flex-wrap items-center justify-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <div className="mt-10 mb-8">
                <img 
                  src={AudioVisorLogo} 
                  alt="AudioVisor Glasses" 
                  className="h-96 w-auto mx-auto"
                />
              </div>
              <p className="text-2xl font-bold text-black dark:text-white">
                Welcome back to AudioVisor!
              </p>
            </div>
          </div>
          ...
          <div className="w-full dark:border-strokedark xl:w-1/2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mt-8 pt-4 text-center text-xs text-bodydark">
                <p>&copy; 2026 AudioVisor. All rights reserved.</p>
              </div>            </div>
          </div>
        </div>
      </div>
